...
export function generateStackBlitzFiles({ templateDir, sourceDir, outputFile, remoteSourcesFile, sources = {}, remoteSources = {}, }) {
    const files = {
        ...readAllFilesFromDirectory(templateDir),
        ...Object.fromEntries(Object.entries(sources).map(([outputPath, sourcePath]) => [
            outputPath,
            readSource(sourceDir, sourcePath),
        ])),
    };
    const remoteSourceFiles = Object.fromEntries(Object.entries(remoteSources).map(([outputPath, sourcePath]) => [
        outputPath,
        readSource(sourceDir, sourcePath),
    ]));
