	...
	<div class="flex items-center gap-2">
		...
		<div class="hidden md:flex">
			...
			<Tooltip title="Twitter / X" placement="left" offset={2}>
				<Button icon={mdiTwitter} href="https://twitter.com/techniq35" class="p-2" target="_blank" />
			</Tooltip>
...
<div class="bg-surface-200 flex min-h-[calc(100vh-64px)]">
	...
	{#if !page.data.metadata?.hideTableOfContents && page.data.metadata?.toc?.length}
		<div class="sticky top-16 hidden max-h-[calc(100dvh-64px)] w-70 overflow-auto py-5 pr-6 xl:block">
			<div
